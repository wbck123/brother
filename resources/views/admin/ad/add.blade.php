...
@section('content')
   <blockquote class="layui-elem-quote f18">{{$title}}</blockquote>
	<div class="page-content">
          <div class="content">
            <form action="/admin/ad" method="post" class="layui-form" enctype="multipart/form-data">
                <div class="layui-form-item">
                    <label for="L_email" class="layui-form-label">
                        <span class="x-red">*</span>广告名称
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="L_email" name="title" required="" lay-verify="title" placeholder="请输入广告名称"
                ...
                <div class="layui-form-item">
                    <label for="L_email" class="layui-form-label">
                        <span class="x-red">*</span>广告连接
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="L_email" name="link" placeholder="请输入广告链接" lay-verify="title"
                        autocomplete="off" class="layui-input">
                    </div>
